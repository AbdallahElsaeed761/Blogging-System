namespace BloggingSystem.DAL.Migrations
{
    ...
    public partial class intial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Article", "ApplicationUserIdentity_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Comment", "ArticleId", "dbo.Article");
            DropForeignKey("dbo.Comment", "ApplicationUserIdentity_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.Comment", new[] { "ApplicationUserIdentity_Id" });
            DropIndex("dbo.Comment", new[] { "ArticleId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Article", new[] { "ApplicationUserIdentity_Id" });
